# Rebrand dari Tribun Purwasuka ke Tribun Purwasuka
...
Write-Log -Message "===== REBRAND TRIBUN PURWASUKA DIMULAI ====="
...
foreach ($file in $htmlFiles) {
    try {
        ...
        $replacements = @(
            ...
            @{ Old = "tribunpurwasuka"; New = "tribunpurwasuka" },
            # Social media links
            @{ Old = "https://twitter.com/tribunpurwasuka"; New = "https://twitter.com/tribunpurwasuka" },
            @{ Old = "https://facebook.com/tribunpurwasuka"; New = "https://facebook.com/tribunpurwasuka" },
            @{ Old = "https://instagram.com/tribunpurwasuka"; New = "https://instagram.com/tribunpurwasuka" },
            @{ Old = "https://youtube.com/@tribunpurwasuka"; New = "https://youtube.com/@tribunpurwasuka" },
            @{ Old = "https://linkedin.com/company/tribunpurwasuka"; New = "https://linkedin.com/company/tribunpurwasuka" },
            # Email
            @{ Old = "tribunpurwasuka@gmail.com"; New = "tribunpurwasuka@gmail.com" },
            # Logo references
            @{ Old = 'alt="TribunPurwasuka"'; New = 'alt="TribunPurwasuka"' }
        )
...
foreach ($file in $packageJsonFiles) {
    try {
        ...
        $replacements = @(
            @{ Old = """name"": ""tribunpurwasuka"""; New = """name"": ""tribunpurwasuka""" },
            @{ Old = """name"": ""tribunpurwasuka-article-generator"""; New = """name"": ""tribunpurwasuka-article-generator""" }
        )
...
$searchPatterns = @("Tribun Purwasuka", "tribunpurwasuka", "TribunPurwasuka")
$foundIssues = @()
...
Write-Log -Message ""
Write-Log -Message "Rebrand Tribun Purwasuka selesai ✅"
